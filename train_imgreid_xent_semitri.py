...
# Datasets
# parser.add_argument('--root', type=str, default='/home/fan047/Experiments/myImplementation/ReID_data',
...
# Architecture
parser.add_argument('-a', '--arch', type=str, default='man', choices=models.get_names())
# Miscs
...
def main():
    ...
    # use_gpu = False
    # args.resume = 'pretrained_model/inceptionV1_bn_noModule.pth.tar'
