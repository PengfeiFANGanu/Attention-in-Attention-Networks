...
class Features(nn.Module):
    def __init__(self, height=256, width=128, nchannels=(480, 832, 1024), num_focused_parts=4, drop_rate=0.1, factor_of_scale_factors=1,
        ...
        self.linearatt_global1 = LinearAttention(nchannels[0], nchannels[0])
        ...
        self.linearatt_global2 = LinearAttention(nchannels[1], nchannels[1])
        ...
        self.linearatt_global3 = LinearAttention(nchannels[2], nchannels[2])
    ...
    def forward(self, x):
        ...
        x1 = self.linearatt_global1(x1)
        x2 = self.inception2(x1)
        x2 = self.linearatt_global2(x2)
        x3 = self.inception3(x2)  # Nx384x16x16
        x3 = self.linearatt_global3(x3)
